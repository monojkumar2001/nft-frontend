...
function BlogDetails() {
  return (
    <>
      <Head>
        <title>NFT Constructer’s Terms of Use</title>
        ...
        <meta
          name="description"
          content="These Terms are only for the benefit of the parties and are not meant to grant any other person or entity the ability to be a third part"
        ></meta>
        <meta
          name="og:description"
          content="These Terms are only for the benefit of the parties and are not meant to grant any other person or entity the ability to be a third part"
        ...
        <meta
          property="og:title"
          content="NFT Constructer’s Terms of Use"
        />
        <meta property="og:image" content="assets/img/meta/terms.jpg" />
        <meta property="image" content="assets/img/meta/terms.jpg" />
        <meta
          name="keywords"
        ...
        <section>
          <div className="container">
            <div className="section-title">
              <p className="sm-title">Terms and service</p>
              <h2 className="sec-title">Terms And Condition</h2>
              <p className="sec-des">
            ...
            <div className="terms-conditions">
              ...
              <p className="urbanist-black-16">
                ...
                AGREEMENT AND CLASS ACTION WAIVER WHICH (WITH LIMITED
              ...
              <p className="urbanist-black-16">
                ...
                license to use, copy, modify, and display any content, including
                but not limited to text, materials, images, files,
                communications, comments, feedback, suggestions, ideas,
